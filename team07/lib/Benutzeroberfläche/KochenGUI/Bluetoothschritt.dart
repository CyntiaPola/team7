  ...
  Widget build(BuildContext context) {
    ...
    return
         Column(
                ...
                child:
                  Center(child: Text("${schritt.anweisung} ",
                      ...
                      builder: (context, verbunden, _) {
                        if (verbunden)
                          return StreamBuilder<List<int>>(
                              stream:
                              bluetoothverbindung_reactive_ble.datenEmpfangen(),
    ...
    builder: (context, toleranz, _) {
      if(((double.parse(String.fromCharCodes(daten)) - schritt.zusatzwert).abs() < toleranz/100.0 *schritt.zusatzwert) ) {
        ...
        color: Colors.red,
           ...
           fontSize: 20,
            ...
            SizedBox(width: 150,
                height: 50,
                child: ElevatedButton(onPressed: (){}, child:Text("Menge bearbeiten",
