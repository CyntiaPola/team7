...
abstract class ICRUDnaehrwerte_pro_100g {
  ...
  Future<Naehrwerte_pro_100g?> getNaehrwertById(int naehrwertid);
  Future<void> updateNaehrwerte_pro_100g(
      int naehrwerte_pro_100g_id, int zutatsname_id, double kcal, double fett, double gesaettigteFettsaeuren,
      double zucker, double eiweiss, double salz);

  Future<int> deleteNaehrwerte_pro_100g(int naehrwert_ID);
}
